...
mod tests {
    ...
    use shared_journal_common::{Entry, Sequence};
    use shared_journal_proto as proto;
    use shared_journal_proto::{ReadRequest, SealRequest, WriteRequest};
    use shared_journal_store::build_store;
