...
impl From<i32> for Role {
    fn from(role: i32) -> Self {
        match shared_journal_proto::Role::from_i32(role) {
            Some(shared_journal_proto::Role::Follower) | None => Role::Follower,
            Some(shared_journal_proto::Role::Leader) => Role::Leader,
        }
    }
}
